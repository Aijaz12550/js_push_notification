...
// Initialize Firebase
 var config = {
   apiKey: "AIzaSyCPXGW3PunCYZAjrE0SL_tYMQfi20MeR9Y",
   authDomain: "push-notificati.firebaseapp.com",
   databaseURL: "https://push-notificati.firebaseio.com",
   projectId: "push-notificati",
   storageBucket: "push-notificati.appspot.com",
   messagingSenderId: "955554500828"
 };
        ...
        snapshot.forEach(function(token) {
            if (token.val() == uid.value) { //Getting the token of the reciever using  if condition..!
                ...
                $.ajax({
                    ...
                    headers: { Authorization: 'key=' + 'AIzaSyDeSTEk4ZGY9dE4eAeXNTARMbgI4p4up10' },
